...
export function CreateGroupGame({ roundManager, onStart, openAdmin, longMemory }) {
    ...
    const rejoinGame = async ({ roundManager, username, longMemory }) => {
        ...
        try {
            ...
            roundManager.userId = response2.data.data[0].user_id;
            ...
            if(response3.data.data.length > 0){
                roundManager.roundNum = response3.data.data[0].round_number;
